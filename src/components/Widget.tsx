...
export function Widget() {
    return (
        <div className="w-[448px] rounded overflow-hidden">
            ...
            <div>
                <div className="bg-zinc-300 font-medium dark:bg-zinc-950 py-2 px-5 text-sm text-zinc-500 dark:text-zinc-400">
                    Recentes
                </div>
                ...
                <div className="divide-y-2 divide-zinc-300 dark:divide-zinc-950">
                    <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
                        ...
                        <div className="flex-1 felx flex-col gap-2" >
                            <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-100" >Você recebeu um convite para fazer parte da empresa Rocketseat.</p>
